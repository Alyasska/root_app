export const uiText = {
  ru: {
    ...
    exportPdfPermissionPrompt: "Подтвердить экспорт в PDF?",
    exportBlankPdf: "Экспорт пустого листа PDF",
    blankPdfPopupBlocked: "Разрешите всплывающее окно, чтобы открыть пустой лист для печати.",
    pdfPopupFallbackPrompt:
      "Браузер заблокировал новое окно. Попробовать печать через встроенный режим на этой странице?",
    pdfInlineFallbackFailed: "Не удалось запустить резервную печать. Разрешите всплывающие окна и попробуйте снова.",
    ...
    appearanceLabel: "Внешние приметы",
  ...
  en: {
    ...
    exportPdfPermissionPrompt: "Confirm PDF export?",
    exportBlankPdf: "Export blank sheet PDF",
    blankPdfPopupBlocked: "Allow pop-ups to open the blank sheet print window.",
    pdfPopupFallbackPrompt:
      "Your browser blocked a new window. Try fallback inline printing from this page instead?",
    pdfInlineFallbackFailed: "Fallback print failed. Please allow pop-ups and try again.",
    ...
    appearanceLabel: "Appearance details",
